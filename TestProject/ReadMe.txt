...
TestProjectDlg.h, TestProjectDlg.cpp - ダイアログ
    これらのファイルには、CTestProjectDlg クラスが含まれます。このクラスはアプリケーションのメイン ダイアログの動作を定義します。ダイアログのテンプレートは、Microsoft Visual C++ で編集できる TestProject.rc に含まれています。
